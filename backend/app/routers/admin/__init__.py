...
from .blog import router as admin_blog_router
...
from .flash_sale import router as admin_flash_sale_router
...
from .reviews import router as admin_reviews_router
